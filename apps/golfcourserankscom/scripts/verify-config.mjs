...
if (!envFile.includes("app_golfcourserankscom_") || !envFile.includes("APP_DB_SCHEMA")) {
...
if (!sql.includes("create schema if not exists app_golfcourserankscom_")) {
...
console.log("Config smoke check passed for golfcourserankscom.");
