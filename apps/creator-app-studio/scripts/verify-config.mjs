...
if (!envFile.includes("app_creator_app_studio") || !envFile.includes("APP_DB_SCHEMA")) {
...
if (!sql.includes("create schema if not exists app_creator_app_studio")) {
...
console.log("Config smoke check passed for creator-app-studio.");
